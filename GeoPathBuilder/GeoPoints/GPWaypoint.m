...
- (NSString*)getGPXString {
    ...
    NSString *GPXTagString = [NSString stringWithString:[GPUtilities createTagWithName:kGPXTAG_WAYPOINT atttributes:pointAttributes andValue:GPXDataString useCDATA:FALSE]];
